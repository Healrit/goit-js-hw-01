...
let request = prompt('How many droids would you like to buy?');
console.log(request);

if (Boolean(request)===false) {
...
if (credits < totalPrice) {
    ...
    const message = `Вы купили ${request} дроидов, на счету осталось ${balance} кредитов.`;
}
